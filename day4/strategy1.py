...
most_sleep = sorted(list(guard_sleep_time.items()), key=lambda _: np.sum(_[1]), reverse=True)[0]
most_asleep_minute = np.argmax(most_sleep[1])
print(int(most_sleep[0]) * most_asleep_minute)
